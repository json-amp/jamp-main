                ...
                conneciton.connect("ws://localhost:8887/",
                        new SimpleWebSocketListener() {
                            ...
                            public void onTextMessage(
                                    WebSocketContext acontext, String text)
                                    throws IOException {
                                ta.append("got: " + text + "\n");
                            ...
                            @Override
                            public void onStart(WebSocketContext acontext)
                                    throws IOException {
                            ...
                            @Override
                            public void onDisconnect(WebSocketContext acontext)
                                    throws IOException {
                            ...
                            @Override
                            public void onClose(WebSocketContext acontext)
                                    throws IOException {
                            ...
                            public void onBinaryMessage(
                                    WebSocketContext acontext, byte[] buffer)
                                    throws IOException {
