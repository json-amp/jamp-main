...
public class MQMessageSenderImpl implements MQMessageSender {
    ...
    public MQMessageSenderImpl(String connectionString, String login, String passcode, JampMessageDecoder aMessageDecoder) throws IOException {
        ...
        if (aMessageDecoder==null) {
            messageDecoder = org.jamp.Factory.factory().createJampMessageDecoder();
        } else {
