 ...
 * I opted for ASCII safe encoding after reading this: http://stackoverflow.com/questions/583562/json-character-encoding
 * */
public class JSONEncoder implements Encoder<String, Object> {
    
    boolean outputType = false; //turned off for now. Thinking of only supporting Plain JSON versus what Jackson does.
